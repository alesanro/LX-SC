...
JobController.deployed().then(j => j.postJobOffer(5, 600, 10, 10))
JobController.deployed().then(j => j.postJobOffer(6, 1200, 10, 20))
JobController.deployed().then(j => j.postJobOffer(7, 1200, 10, 20))
JobController.deployed().then(j => j.postJobOffer(8, 1200, 10, 20))
JobController.deployed().then(j => j.postJobOffer(9, 12000, 10, 20))
